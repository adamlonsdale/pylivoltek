...
[**get_signal_device_status**](DefaultApi.md#get_signal_device_status) | **POST** /ctrller-manager/energystorage/signalDeviceStatus | Signal Device Status
...
# **get_signal_device_status**
> InlineResponse2007 get_signal_device_status(is_use_change_unit, id)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **is_use_change_unit** | [**object**](.md)| Is Use Change Unit?? | 
 **id** | [**object**](.md)| Device ID | 
