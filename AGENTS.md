...
- The CI process defined in `.travis.yml` runs `python -m unittest discover -s test` for the supported Python versions.
- Run `python -m unittest discover -s test` from the repository root. All tests should pass before committing.
